...
<el-card>
    <el-form inline>
        ...
        <x-input exp="model:search.appid;pre:Appid" />
        <x-select exp="model:search.applicationId;label:Application;data:applications;key:id;selectLabel:appid;value:Appid" />
        <x-sort />
        <x-list-head-btn :m="$m" />
    </el-form>
</el-card>
