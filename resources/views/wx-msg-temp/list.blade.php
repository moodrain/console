...
<el-card>
    <el-form inline>
        ...
        <x-input exp="model:search.tempId;pre:TemplateId" />
...
<el-card>
    <el-table :data="list" height="560" border  @selection-change="selectChange">
        ...
        <el-table-column prop="tempId" label="TemplateId"></el-table-column>
        <el-table-column prop="dataJson" label="dataJson"></el-table-column>
        <el-table-column prop="mapJson" label="mapJson"></el-table-column>
